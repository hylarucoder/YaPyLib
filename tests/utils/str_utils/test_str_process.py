...
CHINESE_ARTICLE_CLEANED_ALL_CHINESE_TEXT = "Python·GuidovanRossum1989·ABCPythonBBC·MontyPythonsFlyingCircusABCABCABCPythonC[5][6]PythonAlexMartelli2004PythonGoogleGooglePythonPythonPythonCCPython[7]"
